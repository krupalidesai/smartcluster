<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert Country Data.aspx.cs" Inherits="smartclusters.Web.Insert_Country_Data" %>
...
<body>
    ...
    <form id="form1" runat="server">
     <div class="mainArea">
         <div class="header">Insert Country Data&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             ...
             <tr>
                 ...
                 <td style="text-align:left" class="auto-style15">
                     <table align="center">
                         ...
                         <tr><td class="auto-style13" style="font-family: Calibri; font-size: large">Country Name:</td><td class="auto-style14">
                    ...
                    <asp:ListItem Value="ZW">Zimbabwe</asp:ListItem>
                         ...
                         <tr><td class="auto-style10" style="font-family: Calibri; font-size: large">Population(In Millions):</td><td><asp:TextBox ID="population" runat="server" height="22px" width="170px"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="population" ErrorMessage="Please Enter Population" ForeColor="Red" Font-Names="Calibri" Font-Size="Small"></asp:RequiredFieldValidator>
