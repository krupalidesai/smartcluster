...
[assembly: EdmRelationshipAttribute("smartclustersModel", "Reg_Id", "registration", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, typeof(Smartclusters.Web.registration), "stck_data", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(Smartclusters.Web.stck_data), true)]
[assembly: EdmRelationshipAttribute("smartclustersModel", "Reg_id1", "registration", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, typeof(Smartclusters.Web.registration), "country_data", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(Smartclusters.Web.country_data), true)]
...
namespace Smartclusters.Web
{
    ...
    /// </summary>
    public partial class smartclustersEntities1 : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new smartclustersEntities1 object using the connection string found in the 'smartclustersEntities1' section of the application configuration file.
        /// </summary>
        public smartclustersEntities1() : base("name=smartclustersEntities1", "smartclustersEntities1")
        {
        ...
        /// <summary>
        /// Initialize a new smartclustersEntities1 object.
        /// </summary>
        public smartclustersEntities1(string connectionString) : base(connectionString, "smartclustersEntities1")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new smartclustersEntities1 object.
        /// </summary>
        public smartclustersEntities1(EntityConnection connection) : base(connection, "smartclustersEntities1")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        public ObjectResult<SPGetStockData_Result> SPGetStockData(Nullable<global::System.Int32> reg_id)
        {
            ...
            return base.ExecuteFunction<SPGetStockData_Result>("SPGetStockData", reg_idParameter);
        }
    ...
    public partial class country_data : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("smartclustersModel", "Reg_id1", "registration")]
        public registration registration
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<registration>("smartclustersModel.Reg_id1", "registration").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<registration>("smartclustersModel.Reg_id1", "registration").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<registration> registrationReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<registration>("smartclustersModel.Reg_id1", "registration");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<registration>("smartclustersModel.Reg_id1", "registration", value);
                }
            }
        }
    ...
    public partial class registration : EntityObject
    {
        ...
        public static registration Createregistration(global::System.Int32 reg_Id, global::System.String fname, global::System.String lname, global::System.String e_mail, global::System.String password, global::System.String email, global::System.String confirmPassword)
        {
            registration registration = new registration();
            registration.Reg_Id = reg_Id;
            registration.Fname = fname;
            registration.Lname = lname;
            registration.E_mail = e_mail;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("smartclustersModel", "Reg_Id", "stck_data")]
        public EntityCollection<stck_data> stck_data
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<stck_data>("smartclustersModel.Reg_Id", "stck_data");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<stck_data>("smartclustersModel.Reg_Id", "stck_data", value);
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("smartclustersModel", "Reg_id1", "country_data")]
        public EntityCollection<country_data> country_data
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<country_data>("smartclustersModel.Reg_id1", "country_data");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<country_data>("smartclustersModel.Reg_id1", "country_data", value);
                }
            }
        }
        ...
        public EntityCollection<stck_data> stck_data1
        {
            get
            {
    ...
    public partial class stck_data : EntityObject
    {
        ...
        [BrowsableAttribute(false)]
        [DataMemberAttribute()]
        public EntityReference<registration> registration1Reference
        {
            get
            {
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="smartclustersModel", Name="SPGetStockData_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class SPGetStockData_Result : ComplexObject
    {
    }
